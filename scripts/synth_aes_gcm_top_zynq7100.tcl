...
set out_dir    [file normalize [file join $root_dir "result" "vivado" "aes_gcm_top_zynq7100"]]
...
synth_design -top aes_gcm_top -part $part_name -flatten_hierarchy rebuilt -mode out_of_context
...
puts "SYNTH_DONE: aes_gcm_top $part_name @250MHz"
